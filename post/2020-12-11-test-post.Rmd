...
Example 1:
```{R}
covid <- "Covid caused over 3,000 deaths in one day in the United States and over one million new cases in the span of five days in the United States. It has caused the most physical, social, and economic unrest (proportionally) when compared to other historical tragedies."
```
...
Example 2: We are taking the dataset quakes from R and we are using it in python to measure the central tendency and other aspects of the data.
```{R}
quakes <-quakes
```
